...
(function (global, factory) {
  ...
  function getClasses(options, id) {
    ...
    return [state ? 1 : 0, size, disabled ? 'disabled' : undefined, readonly ? 'readonly' : undefined, indeterminate ? 'indeterminate' : undefined, inverse ? 'inverse' : undefined, id ? 'id-' + id : undefined].filter(function (v) {
      return v == null;
    });
  }
  ...
  function prvelementHandlers() {
    ...
    return this.$element.on({
      ...
      'change.bootstrapSwitch': function changeBootstrapSwitch(event, skip) {
        ...
        _this4.$wrapper.toggleClass(prvgetClass.call(_this4, 0)).toggleClass(prvgetClass.call(_this4, 1));
        if (!skip) {
